...
while(driver.current_url=="https://192.168.142.200/login"):
    ...
    time.sleep(1)
time.sleep(2)
setting=driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/header[2]/div/div/div[2]/ul/li[2]/span/a')
setting.click()
tarlog=driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div/div[2]/div/div/div[4]/div/div/div[2]/button')
tarlog.click()
time.sleep(1)
spansattus=driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div/div[2]/div/div/div[4]/div/div/div[2]/button/span')
print(spansattus.text)
while  spansattus.text=="正在打包":
    time.sleep(1)
    spansattus = driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div/div[2]/div/div/div[4]/div/div/div[2]/button/span')
download=driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div/div[2]/div/div/div[4]/div/div/div[1]/button')
download.click()
time.sleep(15)
driver.quit()