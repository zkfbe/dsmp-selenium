...
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[2]/div/div/ul/li[3]/span/div').click()
time.sleep(1)
driver.find_element(By.XPATH,'//div/div[2]/div/div[2]/div/div/div[2]/button[2]').click()
time.sleep(3)
driver.quit()