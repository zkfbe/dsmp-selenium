...
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[2]/div/div/ul/li[2]/span/div').click()
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div[2]/div/div/div[1]/button').click()
time.sleep(1)
name=driver.find_element(By.XPATH,'/html/body/div[2]/div/div[3]/div/div/div[2]/form/div[1]/div/div[2]/div/div/span/input')
name.send_keys(Keys.CONTROL + 'a')
name.send_keys(Keys.BACKSPACE)
name.send_keys('project3')
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[2]/div/div[3]/div/div/div[3]/div/button[2]').click()
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div[2]/div/div/div[5]/div/div/div[1]/div[2]/div/div/button').click()
time.sleep(1)
