...
while(driver.current_url=="https://192.168.142.200/login"):
    ...
    submit.click()
    time.sleep(1)
setting=driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/header[2]/div/div/div[3]/div/div/div/div[2]/svg')
setting.click()
systemange=driver.find_element(By.XPATH,'/html/body/div[2]/div/div/ul/li[2]')
systemange.click()
time.sleep(2)
# 4、退出访问的实例网站。
driver.quit()