...
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div/div[2]/div/div/div[3]/div/div/div[1]/div/div[1]/div[2]/button').click()
time.sleep(1)
modalContainer = driver.find_element(By.CLASS_NAME,"ant-modal-content")
ak=driver.find_element(By.XPATH,'//div[2]/form/div[7]/div/div[2]/div/div/input')
ak.send_keys(Keys.CONTROL+'a')
ak.send_keys(Keys.BACKSPACE)
ak.send_keys("6675395b47811d2b7c7a8c73")
sk=driver.find_element(By.XPATH,'//div[2]/form/div[8]/div/div[2]/div/div/input')
sk.send_keys(Keys.CONTROL+'a')
sk.send_keys(Keys.BACKSPACE)
sk.send_keys("209f2cbc-440e-4bec-a419-4ad3b441c6f2")
