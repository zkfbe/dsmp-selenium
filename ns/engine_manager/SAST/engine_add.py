...
for element in elements:
    ...
    if "SAST" in text:
        element.click()
        break
driver.find_element(By.XPATH,'//div[2]/form/div[2]/div/div[2]/div/div/input').send_keys("SAST")
...
for element in elements:
    if element.get_attribute("innerText") == "HTTPS":
        element.click()
        break
driver.find_element(By.XPATH,'//div[2]/form/div[5]/div/div[2]/div/div/input').send_keys("192.168.142.181")
driver.find_element(By.XPATH,'//div[2]/form/div[6]/div/div[2]/div/div/div/div[2]/input').send_keys("443")
driver.find_element(By.XPATH,'//div[2]/form/div[7]/div/div[2]/div/div/input').send_keys("668cacf6f4fec4404e921b30")
driver.find_element(By.XPATH,'//div[2]/form/div[8]/div/div[2]/div/div/input').send_keys("42e7da9e-4b3c-439e-ad4d-0b9deb845c3e")
