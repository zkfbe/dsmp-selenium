...
while(driver.current_url=="https://192.168.142.200/login"):
    ...
    time.sleep(1)
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/header[2]/div/div/div[2]/ul/li[6]').click()
time.sleep(1)
driver.find_element(By.XPATH,"/html/body/div[2]/div/div/ul/li[1]").click()
time.sleep(1)
driver.find_element(By.XPATH,'/html/body/div[1]/div/section/div/main/div/div/div/div/div[1]/button').click()
time.sleep(1)
name=driver.find_element(By.XPATH,'//div[2]/form/div[1]/div/div[2]/div/div/span/input')
name.send_keys("post1")
driver.find_element(By.ID,'version').click()
time.sleep(1)
elements=driver.find_elements(By.CLASS_NAME,'ant-select-item-option-content')
elements[0].click()
time.sleep(7)
name.find_element(By.XPATH,"//../../../../../../../../../div[3]/button[2]").click()
time.sleep(1)
while driver.find_element(By.XPATH,'/html/body/div/div/section/div/main/div/div/div/div/div[2]/div/div/div/div/div/div/table/tbody/tr[1]/td[6]/div/span[2]').text=="生成中":
    driver.refresh()
    time.sleep(3)
driver.find_element(By.XPATH,'/html/body/div/div/section/div/main/div/div/div/div/div[2]/div/div/div/div/div/div/table/tbody/tr[1]/td[7]/button[2]').click()
time.sleep(14)
# 4、退出访问的实例网站。
driver.quit()